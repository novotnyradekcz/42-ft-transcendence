export const cs: Record<string, string> = {
  ...
  "Enter `history` for your games history or `leaderboard` for top 10 players:": "Zadejte `history` pro historii her nebo `leaderboard` pro žebříček 10 nejlepších hráčů:",
  "[ history ]": "[ historie ]",
