export const sl: Record<string, string> = {
  ...
  "Enter `history` for your games history or `leaderboard` for top 10 players:": "Vnesite `history` za zgodovino iger ali `leaderboard` za lestvico 10 najboljših igralcev:",
  "[ history ]": "[ zgodovina ]",
